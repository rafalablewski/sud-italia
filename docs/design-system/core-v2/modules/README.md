...
| **Orders** | `/core-v2/orders` | **Wired** — all orders (live & history), filters, Mark paid, Print receipt | [`orders.md`](./orders.md) |
...
All five share the one chrome — `CoreV2Shell` (`src/core-v2/shell/`),
