            ...
            <CardBody style={{ borderTop: "2px solid var(--av3-line)", paddingTop: 16 }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div className="av3-cell-muted" style={{ fontSize: 12, lineHeight: 1.55, marginTop: 4 }}>
                    A pre-launch <strong>dry-run</strong>. Like Sandbox it flips the <strong>whole business</strong> — admin and storefront — onto an isolated dataset, real data untouched. But it starts <strong>completely empty</strong>: you push your own test orders, waste, costs, customers and bookings by hand, exactly as you would once open, to rehearse the full flow before go-live. While on, no real payments, SMS, WhatsApp or scheduled jobs fire. Switch it off and every test row disappears instantly (it&apos;s kept, so you can switch back on and continue). Enabling it turns Sandbox mode off.
                  </div>
                </div>
                <Switch
