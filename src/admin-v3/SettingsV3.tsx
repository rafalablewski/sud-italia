            ...
            <CardBody style={{ borderTop: "2px solid var(--av3-line)", paddingTop: 16 }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div className="av3-cell-muted" style={{ fontSize: 12, lineHeight: 1.55, marginTop: 4 }}>
                    A pre-launch <strong>dry-run</strong>. Like Sandbox it flips the <strong>whole business</strong> — admin and storefront — onto an isolated dataset, real data untouched. First enable <strong>seeds a deep CORE picture</strong> — ~90 days of trading (orders, KDS, tables, slots, staff, schedule, cash, bookings, loyalty) spread across service hours, so Reports, Cohorts, Dayparts and Hourly all have signal and every operational screen is testable straight away; from there you push your own test orders, waste and costs by hand to rehearse the flow before go-live. Your <strong>AI agents keep working</strong> — they analyse this data (daily briefings, customer segments, summaries) so they learn and you can check their output. No real payments, SMS, WhatsApp, billing or backups fire. Switch it off and every test row disappears instantly (it&apos;s kept, so you can switch back on and continue). Enabling it turns Sandbox mode off.
                  </div>
                </div>
                <Switch
