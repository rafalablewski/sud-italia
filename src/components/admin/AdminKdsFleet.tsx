...
import type { FulfillmentType, MenuCategory, OrderStatus } from "@/data/types";
...
const NEXT_LABEL: Record<string, string> = { confirmed: "Start prep", preparing: "Mark ready", ready: "Bump · Done" };
...
function TicketCard({
  ...
  const order = ["pizza", "pasta", "antipasti", "panini", "drinks", "desserts"];
  const groups = new Map<string, WireTicketItem[]>();
