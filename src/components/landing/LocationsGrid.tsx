      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {locations.map((location) => (
            <Card key={location.slug} hover className="flex flex-col">
              {/* Hero gradient placeholder */}
              <div className="relative h-48 bg-gradient-to-br from-italia-red/80 to-italia-gold/80 flex items-end p-5">
