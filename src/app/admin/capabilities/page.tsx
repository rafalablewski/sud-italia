    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          status: "live",
          summary: "18 tools incl. query_orders, query_customers, refund_order, mark_item_86, send_sms, plus the Boardroom advisor reads (get_pnl_snapshot, get_labor_cost, get_menu_engineering, get_inventory_status, get_staff_roster, get_suppliers_and_pos, get_feedback_summary, get_marketing_settings, get_demand_forecast) and update_item_price. Every call audit-logged as actor='claude:<userId>'.",
        },
        {
