...
// KDS = split pass panel, Reports = line chart, Settings = gear.
...
// The three room lenses, in the spec's rail order. Labels are the plain names.
// (Book is not a lens — it's a Service view, reached from the Floor lens tabs.)
